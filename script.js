...
const REMARK_STAT2 = [
  ...
  "공정 제어 실패로 멘탈이 요동치고 있음.",
  "불순물(Impurity)이 섞여 집중력이 바닥을 치는 중임.",
  "수득률(Yield)이 처참하여 멘탈 재결정이 필요한 시점임.",
  "역반응이 우세하여 공부할수록 아는 게 사라지는 기분임.",
  "에너지 수지(Energy Balance)가 안 맞아 금방 지칠 예정임.",
  "시스템이 폭주(Runaway reaction) 직전이라 휴식이 절실함.",
  "열역학 제2법칙에 따라 엔트로피가 무한 증식 중임.",
];
...
const REMARK_ACTION = [
  ...
  "교수님의 질문 세례가 예상되니 복도에서 마주치지 말 것.",
  "실험 데이터 오차가 크니 조용히 재실험을 준비할 것.",
  "계산기 배터리가 나갈 수 있으니 미리 체크할 것.",
  "레포트 폰트가 깨질 수 있으니 제출 전 최종 확인 필수임.",
  "동기에게 밥을 사지 않으면 필기 노트를 못 얻을 위기임.",
  "교수님과 눈이 마주치면 추가 질문이 오니 고개를 숙일 것.",
  "단위 환산 실수 하나로 결과가 뒤집힐 수 있으니 주의할 것.",
  "교수님이 '자네, 이 데이터가 말이 된다고 생각하나?'라고 묻는 환청이 들릴 예정임.",
  "단위 환산(Unit Conversion) 실수로 공정 전체가 폭발할 운수이니 계산기 두 번 두드릴 것.",
  "설계 과제 중 에러(Error)가 무한 루프에 빠질 예정이니 미리 세이브(Save)할 것.",
  "세미나 시간에 교수님과 정확히 눈이 마주쳐 질문 폭탄을 맞을 확률 99%임.",
  "증류탑(Distillation Column) 단수 계산 틀려서 밤샘 확정이니 에너지 드링크를 구비할 것.",
  "재실험 통보를 받을 수 있으니 오늘 하루는 연구실 근처에 얼씬도 하지 말 것.",
  "매틀랩(MATLAB) 코드가 안 돌아가서 하루 종일 'Command Window'만 바라볼 운명임.",
  "레포트 제출 1분 전에 노트북이 블루스크린(Death)을 띄울 수 있으니 주의할 것.",
  "학점 수득률이 10% 미만으로 수렴 중이니 교수님께 메일 쓸 준비를 할 것.",
  "공정 모사(Simulation) 결과가 발산(Diverge)하여 오늘 안에 집에 못 갈 위기임.",
  "안전 밸브가 터지듯 멘탈이 터질 수 있으니 주변 동기들의 위로가 절실함.",
  "중간고사 범위가 광범위하게 팽창(Expansion)하여 뇌 용량을 초과할 예정임.",
];
